...
**Auto-fix:** label the PR with \`cursor:auto-fix\` (or your configured allow label), then reply **to this comment** with \`/cursor-fix\`, use **Quote reply** on this comment, or reply **in the thread** under this Cursor PR Review comment.
