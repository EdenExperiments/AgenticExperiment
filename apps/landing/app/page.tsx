      ...
      <section className="hero-section" aria-label="Hero">
        ...
        <div className="container-landing hero-content">
          ...
          <div className="hero-ctas">
            <a href="http://localhost:3000/register" className="btn-primary">
              Start Your Quest →
            </a>
          ...
          <div className="apps-grid">
            ...
            <ScrollReveal>
              <div className="app-card app-card-lifequest" style={{ height: '100%' }}>
                ...
                <a href="http://localhost:3000" className="btn-primary" style={{ alignSelf: 'flex-start' }}>
                  Enter LifeQuest →
                </a>
              </div>
            </ScrollReveal>
      ...
      <section className="cta-section" aria-label="Call to action">
        <div className="container-landing cta-inner">
          <ScrollReveal>
            ...
            <a href="http://localhost:3000/register" className="btn-primary" style={{ fontSize: '0.9rem', padding: '1rem 2.5rem' }}>
              Create Free Account →
            </a>
          </ScrollReveal>
        </div>
      ...
      <footer className="footer" aria-label="Footer">
        <div className="container-landing footer-inner">
          ...
          <ul className="footer-links">
            ...
            <li><a href="http://localhost:3000/login">Sign In</a></li>
          </ul>
