...
import { signInWithProvider } from '@rpgtracker/auth'
    ...
    <div className="flex flex-col gap-3">
      {providers.map((p) => (
        <button
          ...
          className="social-auth-btn w-full flex items-center justify-center gap-3 py-3 rounded-xl font-medium text-sm transition-all min-h-[48px]"
          style={{
