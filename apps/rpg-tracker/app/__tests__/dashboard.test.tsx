...
test('hub cards enter NutriLog and leave Workout and MindTrack as placeholders', async () => {
  render(<DashboardPage />, { wrapper })
  await waitFor(() => {
  ...
  expect(screen.queryByRole('link', { name: /workout/i })).not.toBeInTheDocument()
