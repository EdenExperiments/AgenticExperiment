...
// --- Mocks set up before any module is imported ---
...
describe('BFF API proxy - route.ts', () => {
  ...
  // Body forwarding: no-body methods must NOT send Content-Type
  ...
  // Body forwarding: body methods forward Content-Type and body
  ...
  // Extra upstream headers are forwarded
